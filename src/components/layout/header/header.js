...
const NavLink = ({ content, link, toggleNav }) => (
  <div className={`${styles.linkWrapper}  nav-link`}>
    <Link to={link} className={styles.link} onClick={toggleNav}>
      {content}
    </Link>
  </div>
);
    ...
    <div className={styles.container}>
      <div className={styles.navWrapper}>
        ...
        >
          ...
          <Navbar.Collapse id="basic-navbar-nav" className={`${styles.linkList} align-items-end justify-content-end`}>
            {/* Links */}
